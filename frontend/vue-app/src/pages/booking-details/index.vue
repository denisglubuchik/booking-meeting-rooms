        ...
        <div v-if="canManageBooking" class="panel stack">
          ...
          <div v-if="selectedReschedule" class="panel stack">
            ...
            <div class="row">
              ...
              <Input v-model="rescheduleDraft.start" type="text" inputmode="numeric" placeholder="ЧЧ:ММ (24ч)" aria-label="Новое время начала" />
              <Input v-model="rescheduleDraft.end" type="text" inputmode="numeric" placeholder="ЧЧ:ММ (24ч)" aria-label="Новое время окончания" />
            </div>
